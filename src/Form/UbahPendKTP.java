 ...
 */
public class UbahPendKTP extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new UbahPendKTPahPendKTP
     */
...
private void id_ktp_siap(){
          try
       {
            ...
            while(rs.next())
            {
                txt_id_ktp.setText(rs.getString(1));
                int value1 =  Integer.parseInt(txt_id_ktp.getText());
                int value2 = value1+1;
                String siap = Integer.toString(value2);
                txt_id_ktp.setText(siap);
            }
       }
catch (Exception e)
{String i;
        i="1";
    txt_id_ktp.setText(i);
    ...
    private void initComponents() {
        ...
        txt_nama_ktp = new javax.swing.JTextField();
        txt_alamat_ktp = new javax.swing.JTextArea();
        txt_rw_ktp = new javax.swing.JTextField();
        txt_rt_ktp = new javax.swing.JTextField();
        jLabel12 = new javax.swing.JLabel();
        txt_id_pendaftaran = new javax.swing.JTextField();
        txt_id_ktp = new javax.swing.JTextField();
        jLabel13 = new javax.swing.JLabel();
        txt_id_pendaftar = new javax.swing.JTextField();
        ...
        jLabel6.setText("RT :");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 295, -1, -1));
        ...
        jPanel1.add(txt_nama_ktp, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 115, 370, -1));

        txt_alamat_ktp.setColumns(20);
        txt_alamat_ktp.setRows(5);
        txt_alamat_ktp.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPanel1.add(txt_alamat_ktp, new org.netbeans.lib.awtextra.AbsoluteConstraints(105, 210, 310, 70));

        txt_rw_ktp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_rw_ktpActionPerformed(evt);
            }
        });
        jPanel1.add(txt_rw_ktp, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 330, 50, -1));
        jPanel1.add(txt_rt_ktp, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 295, 50, -1));

        jLabel12.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel12.setText("ID Pendaftaran :");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 370, -1, -1));
        jPanel1.add(txt_id_pendaftaran, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 370, 50, -1));
        jPanel1.add(txt_id_ktp, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 56, 70, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel13.setText("ID Pendaftar :");
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 370, -1, -1));
        jPanel1.add(txt_id_pendaftar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 370, 50, -1));
    ...
    private void btnsimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsimpanActionPerformed
        ...
        {   String no_kk = txtktpnokk.getText();
            ...
            String nama = txt_nama_ktp.getText();
            String alamat = txt_alamat_ktp.getText();
            ...
            pst.setInt(7, Integer.parseInt(txt_rt_ktp.getText()));
            pst.setInt(8, Integer.parseInt(txt_rw_ktp.getText()));
            pst.setInt(9, Integer.parseInt(txtktpkodepos.getText())); 
            pst.setInt(10, Integer.parseInt(txt_id_pendaftaran.getText()));
            pst.setInt(11, Integer.parseInt(txt_id_pendaftar.getText()));
    ...
    private void btnubahdataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnubahdataActionPerformed
        ...
        try
        {
            ...
            String value3 = txt_nama_ktp.getText();
            String value4 = txtktpnokk.getText();
            String value5 = txtktpnik.getText();
            String value6 = txt_alamat_ktp.getText();
            int value7 = Integer.parseInt(txt_rt_ktp.getText());
            int value8 = Integer.parseInt(txt_rw_ktp.getText());
            int value9 = Integer.parseInt(txtktpkodepos.getText());
            int value10 = Integer.parseInt(txt_id_pendaftaran.getText());
            int value11 = Integer.parseInt(txt_id_pendaftar.getText());
    ...
    private void btnhapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnhapusActionPerformed
        ...
        if(PromptResult==JOptionPane.YES_OPTION)
        {
            try {
                ...
                pst=conn.prepareStatement(sql);
                pst.setString(1, txt_id_ktp.getText());
                pst.execute();
    ...
    private void txt_rw_ktpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_rw_ktpActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_rw_ktpActionPerformed
    ...
    private javax.swing.JTextArea txt_alamat_ktp;
    private javax.swing.JTextField txt_id_ktp;
    private javax.swing.JTextField txt_id_pendaftar;
    private javax.swing.JTextField txt_id_pendaftaran;
    private javax.swing.JTextField txt_nama_ktp;
    private javax.swing.JTextField txt_rt_ktp;
    private javax.swing.JTextField txt_rw_ktp;
