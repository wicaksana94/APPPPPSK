 ...
 * @author novika
 */
public class lapKTP extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Laporan Pendaftaran KTP");
    ...
    private void btnCariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariActionPerformed
        ...
        try {
            ...
            String SQL = "select * from `pendaftaran` where (`tgl_daftar` BETWEEN '"+tgl1+"' and '"+tgl2+"') and jenis_permohonan = 'KTP' ";
