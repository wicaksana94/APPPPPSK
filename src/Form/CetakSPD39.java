...
import static Form.SuratPindahDatang.tgl_kedatangan_ddt;
 ...
 */
public class CetakSPD39 extends javax.swing.JFrame {
    ...
    private void isiKodeDesaKelurahan(){
        ...
        private void isiOtomatisDDT(){
           if (SuratPindahDatang.status_kk_bagi_yg_pindah=="Numpang KK") {
            ...
            String tgl_kedatangan = ((JTextField)tgl_kedatangan_ddt.getDateEditor().getUiComponent()).getText();
            lbl_tgl_kedatangan_ddt.setText(tgl_kedatangan);
            ...
            lbl_dusun_dukuh_kampung_ddt.setText(SuratPindahDatang.txt_dusun_dukuh_kampung_ddt.getText());
...
catch (Exception e)
{
    ...
    private void initComponents() {
        ...
        lbl_dusun_dukuh_kampung_ddt = new javax.swing.JLabel();
        ...
        jLayeredPane2.add(lbl_dusun_dukuh_kampung, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 163, 360, 10));

        lbl_rw_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_rw_dda.setText("lbl_rw_dda");
        jLayeredPane2.add(lbl_rw_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 270, 30, 20));

        lbl_rt_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_rt_dda.setText("lbl_rt_dda");
        jLayeredPane2.add(lbl_rt_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 270, 30, 20));

        lbl_nama_keluarga_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_nama_keluarga_dda.setText("lbl_nama_keluarga_dda");
        lbl_nama_keluarga_dda.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        lbl_nama_keluarga_dda.setVerticalTextPosition(javax.swing.SwingConstants.TOP);
        jLayeredPane2.add(lbl_nama_keluarga_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 380, 10));

        lbl_alamat.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_alamat.setText("lbl_alamat");
        jLayeredPane2.add(lbl_alamat, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 270, 210, 20));

        lbl_no_kk_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_no_kk_dda.setText("lbl_no_kk_dda");
        jLayeredPane2.add(lbl_no_kk_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 330, 10));

        lbl_no_surat.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_no_surat.setText("lbl_no_surat");
        jLayeredPane2.add(lbl_no_surat, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 150, 10));

        lbl_desa_kelurahan.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_desa_kelurahan.setText("lbl_desa_kelurahan");
        lbl_desa_kelurahan.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        jLayeredPane2.add(lbl_desa_kelurahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 146, 210, 10));

        lbl_desa_kelurahan_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_desa_kelurahan_dda.setText("lbl_desa_kelurahan_dda");
        jLayeredPane2.add(lbl_desa_kelurahan_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 299, 150, 20));

        lbl_kecamatan_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_kecamatan_dda.setText("lbl_kecamatan_dda");
        jLayeredPane2.add(lbl_kecamatan_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 312, 150, 30));

        lbl_kodepos_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_kodepos_dda.setText("lbl_kodepos_dda");
        jLayeredPane2.add(lbl_kodepos_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 333, 110, 20));

        lbl_nama_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_nama_dda.setText("lbl_nama_dda");
        jLayeredPane2.add(lbl_nama_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 369, 370, 20));

        lbl_telepon_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_telepon_dda.setText("lbl_telepon_dda");
        jLayeredPane2.add(lbl_telepon_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 333, 150, 20));

        lbl_nik_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_nik_dda.setText("lbl_nik_dda");
        jLayeredPane2.add(lbl_nik_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 352, 340, 20));

        lbl_provinsi_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_provinsi_dda.setText("lbl_provinsi_dda");
        jLayeredPane2.add(lbl_provinsi_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 312, 150, 30));

        lbl_kab_kota_dda.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_kab_kota_dda.setText("lbl_kab_kota_dda");
        jLayeredPane2.add(lbl_kab_kota_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 300, 150, 20));
        ...
        lbl_dusun_dukuh_kampung_dda.setVerticalAlignment(javax.swing.SwingConstants.BOTTOM);
        jLayeredPane2.add(lbl_dusun_dukuh_kampung_dda, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 290, 10));

        lbl_rt_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_rt_ddt.setText("lbl_rt_ddt");
        jLayeredPane2.add(lbl_rt_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 500, 30, 10));

        lbl_rw_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_rw_ddt.setText("lbl_rw_ddt");
        jLayeredPane2.add(lbl_rw_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 500, 40, 10));

        lbl_kab_kota_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_kab_kota_ddt.setText("lbl_kab_kota_ddt");
        jLayeredPane2.add(lbl_kab_kota_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 530, 150, 10));

        lbl_alamat_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_alamat_ddt.setText("lbl_alamat_ddt");
        jLayeredPane2.add(lbl_alamat_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 500, 210, 10));

        lbl_provinsi_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_provinsi_ddt.setText("lbl_provinsi_ddt");
        jLayeredPane2.add(lbl_provinsi_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 539, 140, 20));

        lbl_kecamatan_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_kecamatan_ddt.setText("lbl_kecamatan_ddt");
        jLayeredPane2.add(lbl_kecamatan_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 541, 140, 20));

        lbl_desa_kelurahan_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_desa_kelurahan_ddt.setText("lbl_desa_kelurahan_ddt");
        jLayeredPane2.add(lbl_desa_kelurahan_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 530, 140, 10));

        lbl_tgl_sekarang.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        lbl_tgl_sekarang.setText("lbl_tgl_sekarang");
        jLayeredPane2.add(lbl_tgl_sekarang, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 690, 80, -1));

        lbl_dusun_dukuh_kampung_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_dusun_dukuh_kampung_ddt.setText("lbl_dusun_dukuh_kampung_ddt");
        jLayeredPane2.add(lbl_dusun_dukuh_kampung_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 510, 290, 20));
        ...
        lbl_kode_desa_kelurahan.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        jLayeredPane2.add(lbl_kode_desa_kelurahan, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 143, 100, 10));
        ...
        jLayeredPane2.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 580, 510, 110));
        ...
        jLayeredPane2.add(lbl_status_kk_bagi_yg_pindah_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 417, -1, -1));

        lbl_tgl_kedatangan_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_tgl_kedatangan_ddt.setText("lbl_tgl_kedatangan_ddt");
        lbl_tgl_kedatangan_ddt.setToolTipText("");
        jLayeredPane2.add(lbl_tgl_kedatangan_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 479, 150, 20));

        lbl_nik_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_nik_ddt.setText("lbl_nik_ddt");
        jLayeredPane2.add(lbl_nik_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 450, 280, 10));

        lbl_no_kk_ddt.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        lbl_no_kk_ddt.setText("lbl_no_kk_ddt");
        jLayeredPane2.add(lbl_no_kk_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 429, 290, 20));
        ...
        jLayeredPane2.add(lbl_nama_kepala_keluarga_ddt, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 461, 380, 20));

        lbl_pemohon.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        lbl_pemohon.setText("jLabel2");
        jLayeredPane2.add(lbl_pemohon, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 750, 80, 10));

        Temanggung.setFont(new java.awt.Font("Tahoma", 0, 8)); // NOI18N
        Temanggung.setText("Temanggung");
        jLayeredPane2.add(Temanggung, new org.netbeans.lib.awtextra.AbsoluteConstraints(406, 690, 50, -1));
        ...
        jLayeredPane2.add(lbl_nama_petugas, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 750, 85, 10));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/1.39 kecil.jpg"))); // NOI18N
    ...
    private javax.swing.JLabel lbl_dusun_dukuh_kampung_ddt;
